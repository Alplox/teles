...
export const URLS_JSON_MAIN_CHANNELS = [
...
export const ID_PREFIX_CONTAINERS_CHANNELS = ['modal-canales', 'offcanvas-canales', 'modal-cambiar-canal', 'single-view'];

export const BOOTSTRAP_COL_NUMBER_DESKTOP = 4; // 12/4 = 3 channels per row
export const BOOTSTRAP_COL_NUMBER_MOBILE = 12; // 12/12 = 1 channel per row